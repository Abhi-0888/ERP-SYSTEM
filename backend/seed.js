...
async function bootstrap() {
    ...
    try {
        ...
        const faculty = await userModel.insertMany([
            ...
            { username: 'faculty_cse1', name: 'Prof. Arjun Mehta', password, role: 'FACULTY', universityId: uni._id, departmentId: depts[0]._id, isActive: true, email: 'arjun.m@srmap.edu.in' },
            { username: 'faculty_cse2', name: 'Prof. Deepika Joshi', password, role: 'FACULTY', universityId: uni._id, departmentId: depts[0]._id, isActive: true, email: 'deepika.j@srmap.edu.in' },
            { username: 'faculty_cse3', name: 'Prof. Sanjay Verma', password, role: 'FACULTY', universityId: uni._id, departmentId: depts[0]._id, isActive: true, email: 'sanjay.v@srmap.edu.in' },
            { username: 'faculty_ece1', name: 'Prof. Ramesh Babu', password, role: 'FACULTY', universityId: uni._id, departmentId: depts[1]._id, isActive: true, email: 'ramesh.b@srmap.edu.in' },
            { username: 'faculty_ece2', name: 'Prof. Anitha Kumari', password, role: 'FACULTY', universityId: uni._id, departmentId: depts[1]._id, isActive: true, email: 'anitha.k@srmap.edu.in' },
        ...
        console.log('  Admin/Faculty: admin123');
        ...
        console.log('  exam_controller, placement, student_cse1-student_me1');
